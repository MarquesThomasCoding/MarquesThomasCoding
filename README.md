...
<img src="https://skillicons.dev/icons?i=html,css,sass,bootstrap,tailwind,js,jquery,ts,vue,react,next,nodejs,expressjs,postman,prisma,php,symfony,mysql,firebase,docker,python,figma,wordpress,git,github,gitlab,bitbucket" />
